...
function template(templates, template) {
    return __awaiter(this, void 0, void 0, function () {
        var tplAns, tplOptions, tplOptionsAns;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    tplOptions = (0, common_1.find)(templates, 'value', tplAns.template)[0].options;
                    if (!tplOptions || tplOptions.length === 0) {
                        return [2 /*return*/, __assign({}, tplAns)];
                    }
                    return [4 /*yield*/, inquirer_1.default.prompt(tplOptions)];
                case 4:
                    tplOptionsAns = _a.sent();
                    return [2 /*return*/, __assign(__assign({}, tplAns), { tplConfig: tplOptionsAns })];
            }
        });
    });
}
