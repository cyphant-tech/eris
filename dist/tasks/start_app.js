...
var spawn_process_1 = __importDefault(require("@/utils/spawn_process"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!(0, isPathExist_1.default)(path_1.default.join(appPath, 'node_modules'))) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, installDeps_1.default)(appPath)];
                case 1:
                    retInstall = _a.sent();
                ...
                case 2:
                    ...
                    (0, spawn_process_1.default)(appPath, 'yarn', ['start']);
                    return [2 /*return*/];
            }
        });
    });
