...
var rmdir = (0, util_1.promisify)(fs_1.default.rmdir);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(entries.map(function (entry) { return __awaiter(_this, void 0, void 0, function () {
                            var fullPath;
                            return __generator(this, function (_a) {
                                fullPath = path_1.default.join(dir, entry);
                                // const fileStat = await stat(fullPath);
                                return [2 /*return*/, fs_1.default.lstatSync(fullPath).isDirectory() ? rmdirs(fullPath) : unlink(fullPath)];
                            });
                        }); }))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, rmdir(dir)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
